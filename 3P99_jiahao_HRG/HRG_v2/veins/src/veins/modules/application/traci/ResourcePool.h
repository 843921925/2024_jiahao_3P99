...
//        bool isRequestServed(const std::string& requestId, const std::map<veins::LAddress::L2Type, simtime_t>& connectedNodes);
    ...
    public:
        ...
        std::unordered_map<long, std::vector<double>> requestKValue;
        ...
        std::vector<double> k1_LostHistory;
        std::vector<double> k2_LostHistory;
        std::vector<double> k3_LostHistory;
